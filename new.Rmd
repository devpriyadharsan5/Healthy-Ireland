...
```{r}
file_path <- "~/Major Project/0021-04_healthy_ireland_2018.sav"
```
...
n1<- to_factor((n), drop_unused_labels=TRUE, ordered=TRUE)
...
```{r}
#count
ggplot(n1, aes(x=ageclass, y=n$q6, fill=q6)) + 
