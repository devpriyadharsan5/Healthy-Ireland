...
1. **Among individuals aged 15-24 years**:
   
   * Non-smokers: Approximately 1.6% of both males and females reported bad health conditions, while around 12.2% of males and 10.5% of females reported good health conditions. Moreover, about 27.2% of males and 27% of females reported very good health conditions.
   
   * Smokers: Similar to non-smokers, around 1.6% of both males and females reported bad health conditions. However, the percentage of smokers reporting good health conditions was slightly lower, with approximately 4.3% of males and 2.6% of females. Additionally, around 5.3% of males and 4.8% of females reported very good health conditions.

2. **Among individuals aged 25-44 years**:
   
   * Non-smokers: About 2.1% of males and 3.4% of females reported bad health conditions. Moreover, around 9.1% of males and 14.3% of females reported good health conditions, while approximately 18.3% of males and 29% of females reported very good health conditions.
  
   * Smokers: Among smokers, roughly 1.6% of males and 1.5% of females reported bad health conditions. The percentage of smokers reporting good health conditions was approximately 3.6% of males and 4.7% of females. Additionally, about 6.6% of males and 5.8% of females reported very good health conditions.

3. **Among individuals aged 45-64 years**:
   
   * Non-smokers: Around 6.2% of males and 6.9% of females reported bad health conditions. Additionally, approximately 14.3% of males and 17.9% of females reported good health conditions, while about 14% of males and 21.3% of females reported very good health conditions.
   
   * Smokers: Among smokers, approximately 3.2% of males and 2.2% of females reported bad health conditions. The percentage of smokers reporting good health conditions was around 4.4% of males and 4.4% of females. Furthermore, roughly 2.1% of males and 3.2% of females reported very good health conditions.

4. **Among individuals aged 65 and over**:

   * Non-smokers: Approximately 12.8% of males and 13.8% of females reported bad health conditions. Moreover, around 20% of males and 22.4% of females reported good health conditions, while about 8.6% of males and 11.8% of females reported very good health conditions.
   
   * Smokers: Among smokers, around 2.6% of males and 1.5% of females reported bad health conditions. The percentage of smokers reporting good health conditions was approximately 2.5% of males and 2.3% of females. Additionally, roughly 0.6% of males and 1.1% of females reported very good health conditions.


Overall, these findings underscore the importance of avoiding smoking to maintain better health outcomes, especially among younger individuals. It is evident that smoking is associated with an increased likelihood of experiencing bad health conditions across different age groups and genders. Public health initiatives and targeted interventions should continue to emphasize the harmful effects of smoking and encourage smoking cessation to improve overall health and well-being.
...
ggplot(health_ins_smoke, aes(x = ageclass, y = perc, fill=q55)) +
  ...
  labs(x = "Age", y = "Percentage")+
  ggtitle("Health Insurance for People smoke")+
  guides(color = guide_legend(reverse = TRUE))+
  theme(axis.text.x = element_text(angle = 30,hjust=1))+
  facet_wrap(~q6+q52,labeller = label_both)

```


1. For individuals with private health insurance:
   * Among females with private health insurance, the smoking rates vary across different age groups. The lowest smoking rate is observed among females aged 15-24 years (0.70%), while the highest smoking rate is among females aged 45-64 years (4.77%). It is worth noting that females aged 65 and over have a relatively lower smoking rate (4.91%).
   
   * Among males with private health insurance, the smoking rates are generally higher compared to females. The highest smoking rate is among males aged 25-44 years (4.84%), followed by males aged 45-64 years (4.21%). Males aged 15-24 years have a relatively lower smoking rate (1.19%), and males aged 65 and over have the lowest smoking rate (1.89%).


2. For individuals without private health insurance:
  
   * Among females without private health insurance, the smoking rates vary across age groups. The highest smoking rate is observed among females aged 45-64 years (12.27%), which is significantly higher compared to females with private health insurance in the same age group. Females aged 15-24 years have a relatively lower smoking rate (1.63%), and females aged 25-44 years have the lowest smoking rate (2.25%). Females aged 65 and over also show a relatively lower smoking rate (7.60%).
  
   * Among males without private health insurance, the smoking rates are relatively higher compared to females. The highest smoking rate is among males aged 45-64 years (6.12%), followed by males aged 65 and over (6.54%). Males aged 15-24 years have a relatively lower smoking rate (1.75%), and males aged 25-44 years have the lowest smoking rate (6.09%).
...
ggplot(h1, aes(x = ageclass, y = perc, fill = spq1)) +
  ...
  guides(color = guide_legend(reverse = TRUE))+
  theme(axis.text.x = element_text(angle = 30,hjust=1))+
  facet_grid(vars(q14), vars(q52),labeller = label_both)

```


The distribution of alcohol consumption varies among different age groups and genders in relation to health conditions. Here is a breakdown of the data:

1. Among individuals aged **15-24 years**, the majority of non-drinkers (No) report good or very good health conditions, while a small proportion report bad health conditions. Among drinkers (Yes), the percentages are relatively higher for good and very good health conditions, but there is also a noticeable increase in the proportion of individuals reporting bad health conditions.

2. For individuals aged **25-44 years**, a similar pattern is observed. Non-drinkers tend to have higher proportions of good and very good health conditions, while drinkers have higher percentages of individuals reporting bad health conditions.

3. Among individuals aged **45-64 years**, the distribution remains consistent. Non-drinkers have higher rates of good and very good health conditions compared to drinkers, with a smaller proportion reporting bad health conditions.

4. For individuals aged **65 and over**, non-drinkers generally have higher percentages of good and very good health conditions. However, it is worth noting that the difference between drinkers and non-drinkers is less pronounced in this age group.


In conclusion, the analysis suggests that alcohol consumption is associated with a higher likelihood of individuals reporting bad health conditions across different age groups and genders. Non-drinkers consistently have higher rates of good and very good health conditions compared to drinkers, indicating a potential negative impact of alcohol consumption on overall health. These findings highlight the importance of promoting responsible drinking habits and raising awareness about the potential health risks associated with excessive alcohol consumption, particularly among younger age groups.
...
ggplot(health_ins_al, aes(x = ageclass, y = perc, fill=q55)) +
  ...
  guides(color = guide_legend(reverse = TRUE))+
  theme(axis.text.x = element_text(angle = 30,hjust=1))+
  facet_wrap(~q14+q52,labeller = label_both)
...
### 18. How do individuals rate their own health in general, and are there differences between genders and age groups?


```{r, echo = FALSE, warning=FALSE,message=FALSE}
s18 <- n1 %>% 
  dplyr::group_by(spq1, q52, ageclass) %>% 
  dplyr::summarise(count = n()) |>
  drop_na() |>
  ungroup() %>%
  group_by(spq1) %>%
  dplyr::mutate(perc = count/sum(count)*100) %>%
  dplyr::select(spq1, q52, ageclass, count)


health <- 
  s18 %>% 
  group_by(spq1, q52,ageclass) %>% 
  dplyr::summarise(count = sum(count)) %>% 
  ungroup() %>% 
  group_by(ageclass,q52) %>% 
...
ggplot(health, aes(x = q52, y = perc, fill = spq1)) +
  ...
  ggtitle("Proportion of Individuals Rating Their Health by Gender and Age Group")+
  facet_wrap(~ageclass)
...
example_dat <- example_dat %>% mutate(q6_binary = as.numeric(as.factor(q6)) - 1)

# Fit the Random Forest model
random_forest <- randomForest(q6_binary ~ ageclass + q52, data = example_dat, ntree = 100)
...
The logistic regression model was fitted using the formula `q6_binary ~ ageclass + q52` with the binomial family, indicating that the outcome variable `q6_binary` is a binary variable (smoker or non-smoker). The model was applied to the `example_dat` dataset.


The intercept represents the estimated log-odds of being a smoker when all other predictors are zero. The coefficients for ageclass and q52 represent the estimated changes in log-odds of being a smoker associated with each level of the corresponding predictor, relative to the reference level.

The degrees of freedom indicate that there were 7698 observations in total, with 7694 residual degrees of freedom after accounting for missing data (2 observations were deleted due to missingness).

The null deviance measures the deviance of the null model (i.e., a model with only an intercept term) from the observed data. In this case, the null deviance is 7379.

The residual deviance measures the deviance of the fitted model from the observed data. A smaller residual deviance suggests a better fit. In this case, the residual deviance is 7199.

The AIC (Akaike Information Criterion) is a measure of model quality that penalizes complex models. In this case, the AIC value is 7209.

Overall, based on this logistic regression model, the coefficients provide estimates of the relationship between the predictors (ageclass and q52) and the log-odds of being a smoker. The negative coefficients for ageclass suggest a decreasing trend in the log-odds of being a smoker as age class increases. The positive coefficient for ageclass.C indicates a slightly increasing trend in the log-odds of being a smoker for the "C" age class compared to the reference level. The negative coefficient for q52.L suggests a decrease in the log-odds of being a smoker for the given level of q52 compared to the reference level.

The residual deviance is lower than the null deviance, indicating that the model provides a better fit to the data than the null model. However, the AIC value suggests that there may be room for improvement in the model's predictive ability.
...
# Fit the decision tree model
decision_tree1 <- rpart(q14_binary ~ ageclass + q52, data = train_data, method = "class")
