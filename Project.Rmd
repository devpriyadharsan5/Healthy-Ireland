...
predicted_classes_logistic <- ifelse(predict(logistic_mod, newdata = test_data, type = "response") > 0.25, "Yes", "No")
...
# AIC is a measure of the model's goodness of fit, considering both the model's accuracy and complexity. 
# Lower AIC values indicate a better fit, balancing the trade-off between model performance and simplicity.

aic_value <- AIC(logistic_mod)

# Calculate BIC (Bayesian Information Criterion) for the logistic regression model.
# BIC is similar to AIC but penalizes more for model complexity, making it suitable for model selection.
# Like AIC, lower BIC values indicate a better fit with a balance between accuracy and model simplicity.
...
predicted_classeslog1 <- ifelse(predict(logistic_mod1, newdata = test_data1, type = "response") > 0.7, "Yes", "No")
...
aic_value <- AIC(logistic_mod1)


# Calculate BIC (Bayesian Information Criterion) for the logistic regression model.
# BIC is similar to AIC but penalizes more for model complexity, making it suitable for model selection.
# Like AIC, lower BIC values indicate a better fit with a balance between accuracy and model simplicity.
bic_value <- BIC(logistic_mod1)
...
predicted_classes_nb1_threshold <- ifelse(predicted_probs_nb1[, "Yes"] > 0.75, "Yes", "No")
